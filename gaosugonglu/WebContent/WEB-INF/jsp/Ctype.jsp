	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="ctype/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${ctype['id'] }">
					<ul class="forminfo">
						<li><label>车辆类型<b>*</b></label><input id="name" value="${ctype['name'] }"
							name="name" type="text" class="dfinput" placeholder="请填写车辆类型"
