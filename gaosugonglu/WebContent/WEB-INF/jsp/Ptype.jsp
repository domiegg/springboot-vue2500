	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="ptype/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${ptype['id'] }">
					<ul class="forminfo">
						<li><label>收费类型<b>*</b></label><input id="name" value="${ptype['name'] }"
							name="name" type="text" class="dfinput" placeholder="请填写收费类型"
