	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="station/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${station['id'] }">
					<ul class="forminfo">
						<li><label>收费站名称<b>*</b></label><input id="name" value="${station['name'] }"
							name="name" type="text" class="dfinput" placeholder="请填写收费站名称"
