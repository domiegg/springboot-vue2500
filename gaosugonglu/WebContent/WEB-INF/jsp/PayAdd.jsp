	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="pay/informationAdd" method="POST"
					onsubmit="return checkSubmit();">
					<ul class="forminfo">
						<li><label>收费名称<b>*</b></label><input id="name" 
							name="name" type="text" class="dfinput" placeholder="请填写收费名称"
							style="width: 518px;" /></li>
						<li><label>车辆号牌<b>*</b></label><input id="code" 
						...
						<li><label>收费金额<b>*</b></label><input id="price" 
							name="price" type="text" class="dfinput" placeholder="请填写收费金额"
							style="width: 518px;" /></li>
						<li><label>备注<b>*</b></label><textarea id="content7" name="content"></textarea></li>
